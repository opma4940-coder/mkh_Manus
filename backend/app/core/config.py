...
# Repository Root - Adjusted for new structure
# Path(__file__) is /app/backend/app/core/config.py inside container
# We want /app
REPO_ROOT = Path("/app")
...
# Runtime Settings
RUNTIME_POLL_INTERVAL_SEC = 0.5
CYCLE_STEPS_DEFAULT = 10
TOKEN_SOFT_BUDGET_FRACTION = 0.98
