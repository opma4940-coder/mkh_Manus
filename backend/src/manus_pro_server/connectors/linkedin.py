# ═══════════════════════════════════════════════════════════════════════════════
# Linkedin Connector - موصل لينكد إن (مُنفّذ بالكامل)
# ═══════════════════════════════════════════════════════════════════════════════
...
class LinkedinConnector(OAuthConnector):
    def __init__(self, connector_id: str, name: str, config: Dict[str, Any]):
        ...
        self.base_url = "https://api.linkedin.com/v2/me"
    ...
    def get_authorization_url(self, state: Optional[str] = None) -> str:
        ...
        return f"https://www.linkedin.com/oauth/v2/authorization?client_id={client_id}&redirect_uri={redirect_uri}&response_type=code&scope=r_liteprofile&state={state}"
