# ═══════════════════════════════════════════════════════════════════════════════
# Instagram Connector - موصل انستغرام (مُنفّذ بالكامل)
# ═══════════════════════════════════════════════════════════════════════════════
...
class InstagramConnector(OAuthConnector):
    def __init__(self, connector_id: str, name: str, config: Dict[str, Any]):
        ...
        self.base_url = "https://graph.facebook.com/v12.0/me/media"
    ...
    def get_authorization_url(self, state: Optional[str] = None) -> str:
        ...
        return f"https://api.instagram.com/oauth/authorize?client_id={client_id}&redirect_uri={redirect_uri}&response_type=code&scope=instagram_basic&state={state}"
