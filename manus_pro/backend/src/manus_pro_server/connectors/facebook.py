# ═══════════════════════════════════════════════════════════════════════════════
# Facebook Connector - موصل فيسبوك (مُنفّذ بالكامل)
# ═══════════════════════════════════════════════════════════════════════════════
...
class FacebookConnector(OAuthConnector):
    def __init__(self, connector_id: str, name: str, config: Dict[str, Any]):
        ...
        self.base_url = "https://graph.facebook.com/me"
    ...
    def get_authorization_url(self, state: Optional[str] = None) -> str:
        ...
        return f"https://www.facebook.com/v12.0/dialog/oauth?client_id={client_id}&redirect_uri={redirect_uri}&response_type=code&scope=pages_manage_posts&state={state}"
